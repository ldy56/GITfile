...
public class EmailSendTool1 {
	...
	public EmailSendTool1(String host, String mail_from, String mail_to,
	...
	public void send() throws GeneralSecurityException, MessagingException {
        ...
        Authenticator auth = new Email_Autherticator("992928320@qq.com", "fugkadvlgxeabfgg"); // 进行邮件服务器用户认证  
	...
	public static void main(String[] args) {
		EmailSendTool1 sendEmail = new EmailSendTool1("smtp.qq.com",  
                "992928320@qq.com", "806677654@qq.com", "test", "邮件内容");  
