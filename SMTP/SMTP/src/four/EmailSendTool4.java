...
public class EmailSendTool4 {
	...
	public EmailSendTool4(String host, String mail_from, String mail_to,
	...
	public void send() throws GeneralSecurityException, MessagingException {
        ...
        text.setContent("使用JavaMail创建带附件的邮件", "text/html;charset=UTF-8");// 设置邮件正文  
	...
	public static void main(String[] args) {
		EmailSendTool4 sendEmail = new EmailSendTool4("smtp.qq.com",  
